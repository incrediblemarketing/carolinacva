...
function im_register_styles() {
	...
	wp_register_style( 'google-fonts', 'https://fonts.googleapis.com/css?family=Open+Sans+Condensed:300,700|Open+Sans:400,400i,600,700&display=swap', '', $theme_version, 'all' );
