...
<div class="container">
	<div class="row align-items-center">
		<div class="col-xl-6 offset-xl-3 content">
			<h2><?php echo esc_attr( $content_title ); ?></h2>
			<?php echo $content; ?>
		</div>
		<div class="col-xl-3">
			<?php if ( $side_image ) : ?>
				<div class="image--holder blue--circle">
...
<?php get_template_part( 'components/svg/blue-line-to-left' ); ?>
